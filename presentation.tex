...
\def\sixthrowcolor{}
\def\seventhrowcolor{}
\only<4>{\def\fourthrowcolor{\rowcolor{lightgray}}}
\only<5>{\def\fifthrowcolor{\rowcolor{lightgray}}}
\only<6>{\def\sixthrowcolor{\rowcolor{lightgray}}}
\only<7>{\def\seventhrowcolor{\rowcolor{lightgray}}}
